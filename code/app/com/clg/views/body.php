...
jQuery(document).ready(function(){
	...
	estado['0000'] = {label:'<span class="label label-danger"><i class="fa fa-times"></i></span>',text:'SINREGISTRO', abrv: '', color:'#00AAFF'};
	estado['0001'] = {label:'<span class="label label-success"><i class="fa fa-thumbs-up"></i></span>',text:'PRESENTE', abrv: 'P', color:'#139302'};
	estado['0002'] = {label:'<span class="label label-default"><i class="fa fa-square-o "></i></span>',text:'TARDE', abrv: 'T', color:'#D87F00'};
	estado['0003'] = {label:'<span class="label label-danger"><i class="fa  fa-times"></i></span>',text:'FALTA', abrv: 'F', color:'#FF0000'};
...
<script src="<?php echo BASURL?>app/com/clg/scripts/init.js"></script>