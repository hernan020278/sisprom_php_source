var apci = {
	...
	import: function(callback){
		Sisem.import({listaArchivo:['adm/sucu','cmn/usua','adm/oper']}, function(rpta){
	...
	winPop:function(w){
		apci.import(function(){
			...
			w.changenum = function(){
				Sisem.blockW(w.$e);
				Sisem.ejecutar('GetListaPropiedad',{prp_kysuc:w.$e.find('[name=caj_kysuc]').val(), prp_secc:'0003', }, function(rpta){
