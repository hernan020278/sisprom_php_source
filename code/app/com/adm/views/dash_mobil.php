...
<div class="col-xs-3 col-sm-3"><input type="text" name="ope_pfin" class="form-control input-sm" placeholder="yyyy-mm-dd" title="ope" tabindex="1"/></div>
<div class="col-xs-2 col-sm-2"><select name="bal_niv0"  class="form-control input-sm" title="ope" placeholder="Rubro" tabindex="14"></select></div>
<div class="col-xs-3 col-sm-3">
	<div class="input-group input-group-sm">
		<select name="bal_niv1" class="form-control" title="ope" placeholder="Clase" tabindex="14"></select>
				...
				<div id="myTabContent" class="tab-content">
					...
					<div class="tab-pane fade active in padding-5 no-padding-bottom" id="tabDashGeneral">
        				...
        				<div class="widget-body widget-hide-overflow">
        					<div id="idBrwDashgeneral">
    							<div class="table-responsive" name="grid"></div>
        					</div>
