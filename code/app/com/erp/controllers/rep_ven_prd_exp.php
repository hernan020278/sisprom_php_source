<?php 
class rep_ven_prd_exp extends Controlador
{
 	...
 	public function printReport($data)
 	{
 		...
 		try
 		{
			$suc_kysucu = ((isset($data['suc_kysucu']))?$data['suc_kysucu']:"");
 			...
 			$where = "doc.esta!='0000' and doc.esta!='0003' and art.tipo='PRODUCTO'";
 			...
 			$reportData['data']['lista']=$this->documento->listaExportWithParent("SELECT", 0, 10000, $where, "");
