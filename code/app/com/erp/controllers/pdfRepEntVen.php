...
class pdfRepEntVen extends Controlador {
	...
	public function index(){
		...
		$respNiv1=$this->documento->listaMix( $id_sucu, $id_enti, '', '0002', $fini, $ffin);
		if($respNiv1!=false){
			foreach($respNiv1 as $fil1){
				...
				$respNiv2=$this->documento->listaMix($id_sucu, $id_enti, $fil1->id_docu, '0008', $fini, $ffin);
				if($respNiv2!=false){
