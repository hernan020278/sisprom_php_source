	...
	<div class="row" style="background: #57889C;">
		<div style="float: left;  margin:0px 0px 0px 17px;">
			<div class="smart-form" style="float: left;">
				<label class="checkbox"><input type="checkbox" name="main_sel_sucu"><i></i></label>
			</div>	
...
<script src="<?php echo BASURL?>js/jquery-touch/jquery.ui.touch-punch.min.js"></script>
<script src="<?php echo BASURL?>js/math.js"></script> 

<script src="<?php echo BASURL?>js/flot/jquery.flot.cust.js"></script>
<script src="<?php echo BASURL?>js/flot/jquery.flot.resize.js"></script>
<script src="<?php echo BASURL?>js/flot/jquery.flot.tooltip.js"></script>

<script	src="<?php echo BASURL?>app/com/erp/scripts/init.js"></script>
