<style>
	...
	.table.table-bordered > tbody > tr > td.dtd_sact {
		text-align: center;
		width: 5%;
	}
	.table.table-bordered > tbody > tr > td.dtd_pcos {
		text-align: right;
		width: 8%;
	}
	.table.table-bordered > tbody > tr > td.art_pund {
		text-align: right;
		width: 8%;
	}
</style>
<header>Informacion de Compra</header>
...
<div class="row">
	...
	<div class="col-md-2">
 		<select name="doc_tdoc" class="form-control" placeholder="Tipo comprobante"></select>
	</div>
	<div class="col-md-2">
...
<div class="row">
	<div class="col-md-2" style="display: none;">
   		<select name="doc_tven" class="form-control" placeholder="Tipo documento">
	...
	<div class="col-md-1" style="display: none;">
   		<select name="doc_tmon" class="form-control" placeholder="Tipo documento">
	...
	<div class="col-md-2">
		<input type="text" name="doc_fact" class="form-control" placeholder='Factura compra'>
	</div>
	<div class="col-md-2">
		<input type="text" name="doc_guia" class="form-control" placeholder='Guia de remision'>
	</div>
	<div class="col-md-2">
   		<select name="doc_fpag" class="form-control" placeholder="Tipo documento">
...
<div class="row">
	<div class="col-md-11">
		...
		<input type="hidden" name="art_clas" value="0"/>
...
<div class="row">
	<div class="col-md-7">
		<input type="text" name="art_nomb" class="form-control" style="text-align: left;" placeholder="Producto" obligatorio="NO"/>
	</div>
	<div class="col-md-2">
		<input type="text" name="art_marc" class="form-control" style="text-align: left;" placeholder="Marca" obligatorio="NO"/>
	</div>
	<div class="col-md-1">
		<input type="text" name="art_unid" class="form-control" style="text-align: left;" placeholder="Unidad" obligatorio="NO"/>
	</div>
	<div class="col-md-1">
		<input type="number" name="dtd_cant" class="form-control" style="text-align: center" placeholder="Cantidad" obligatorio="NO"/>
	</div>
	<div class="col-md-1">
		<input type="number" name="dtd_pcos" class="form-control" style="text-align: right;" placeholder="Costo" obligatorio="NO"/>
	</div>
</div>
<div class="row">
  	...
  	<table style="display:none;">
  		<tbody name="gridRef">
  			<tr>
    			...
    			<td name="grid_dtd_pund" class="dtd_pund">3.65</td>
    			<td name="grid_dtd_impo" class="dtd_impo">15.458</td>
    			<td name="grid_dtd_sact" class="dtd_sact">2.52</td>
    			<td name="grid_dtd_pcos" class="dtd_pcos">4.86</td>
    			<td name="grid_art_pund" class="art_pund">6.485</td>
  			</tr>
  		</tbody>
  	</table>
  </div>
