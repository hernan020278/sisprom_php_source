					...
					if(rpta!=null){
						...
						if(rpta.data.lista!=null){
							...
							fila++;workSheetData.push([
								...
								{value:'USUARIO',metadata: {style: headerStyle.id}},
								...
								{value:'TIPO/DESCRIPCION',metadata: {style: headerStyle.id}},
								{value:'GERENCIA/AREA',metadata: {style: headerStyle.id}},
								{value:'DENOMINACION',metadata: {style: headerStyle.id}},
							...
							for(var i=0;i<rpta.data.lista.length;i++)
							{
								fila++;workSheetData.push([
									...
									rpta.data.lista[i].traNomb,
									rpta.data.lista[i].pdrNomb,
									rpta.data.lista[i].cliCodi,
									rpta.data.lista[i].cliNdoc,
									rpta.data.lista[i].cliNomb,
									
									rpta.data.lista[i].catNomb,
									rpta.data.lista[i].areNomb,
									rpta.data.lista[i].denNomb,
									rpta.data.lista[i].divNomb,
									rpta.data.lista[i].gruNomb,
									estado[rpta.data.lista[i].cliEsta].text,
								...
								cliCant+=parseFloat(rpta.data.lista[i].cant);
								cliTota+=parseFloat(rpta.data.lista[i].prec);
								cliImpo+=parseFloat(rpta.data.lista[i].impo);
								
								genCant+=parseFloat(rpta.data.lista[i].cant);
								genTota+=parseFloat(rpta.data.lista[i].prec);
								genImpo+=parseFloat(rpta.data.lista[i].impo);
								if(cliCodiAct!=cliCodiPos)
								{
									var filEmpty=new Array(19);
									filEmpty[6]={value: 'Total '+rpta.data.lista[i].cliNomb, metadata: {style: footerStyle.id}};
									filEmpty[17]={value: parseFloat(cliCant), metadata: {style: footerStyle.id}};
									filEmpty[18]={value: parseFloat(cliTota), metadata: {style: footerStyle.id}};
									filEmpty[19]={value: parseFloat(cliImpo), metadata: {style: footerStyle.id}};
...
//									worksheet.mergeCells('F'+fila, 'K'+fila);
							...
							var filEmpty=new Array(19);
							filEmpty[6]={value: 'Total ', metadata: {style: footerStyle.id}};
							filEmpty[17]={value: parseFloat(genCant), metadata: {style: footerStyle.id}};
							filEmpty[18]={value: parseFloat(genTota), metadata: {style: footerStyle.id}};
							filEmpty[19]={value: parseFloat(genImpo), metadata: {style: footerStyle.id}};
							fila++;workSheetData.push(filEmpty);//fila en blanco
